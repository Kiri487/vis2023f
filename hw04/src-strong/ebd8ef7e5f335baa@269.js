...
- 北、南、東部工作者的工作處中，沒有在推動永續事務的地方占比排名第二（在中部則是排名第三），這顯示許多藝術工作者的工作場所並未積極參與永續發展的推動`
)}
...
d3
  .scaleOrdinal()
  .domain(["北部", "中部", "南部", "有，以行動或計畫進行", "有，制定藝術永續推動章程", "有，設置專門的永續部門處理", "沒有"])
  .range(["#CBD6F7","#92A3D9","#6B7BAD","#CDB1E4","#937CA6","#725D82", "#CB4042"])
  .unknown("#CECECE")
)}
