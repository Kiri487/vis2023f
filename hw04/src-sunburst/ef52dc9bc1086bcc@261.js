...
md`# HW4 Simple baseline (3pt) / Medium baseline (4pt)`
)}
...
md`## 結論
根據上圖，可以得出：
- 問卷參與者中，工作室的藝術工作者占比最多，其次是在替代空間工作者
- 最多人採取的減少碳排放行動是減少包裝和文宣印刷
- 在工作室、替代空間、非營利組織／藝術團體工作的工作者中，主要的減碳排行動都是「減少包裝材及文宣印製」、「使用無毒媒材、再生材料、廢物利用素材等」及「工作場所、活動展場的節約能源」
- 與其他工作環境相比，美術館的藝術工作者更注重「工作場所、活動展場的節約能源」，其次是「減少包裝材及文宣印製」，「使用無毒媒材、再生材料、廢物利用素材等」則占比較少`
)}
...
d3
  ...
  .range(["#CBD6F7","#92A3D9","#6B7BAD","#CDB1E4","#937CA6","#725D82"])
  .unknown("#CECECE")
)}
