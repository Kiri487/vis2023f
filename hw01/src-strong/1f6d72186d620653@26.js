...
function _studenttable(__query,FileAttachment,invalidation){return(
__query(FileAttachment("studentTable.csv"),{from:{table:"studentTable"},sort:[],slice:{to:null,from:null},filter:[],select:{columns:null}},invalidation)
)}
...
function _6(studentArray,data,homeworks)
{
...
function _10(d3,studentArray,homeworks)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("studenttable")).define("studenttable", ["__query","FileAttachment","invalidation"], _studenttable);
  ...
  main.variable(observer()).define(["studentArray","data","homeworks"], _6);
  main.variable(observer()).define(["md"], _7);
  main.variable(observer()).define(["md"], _8);
  main.variable(observer()).define(["Plot","d3"], _9);
  main.variable(observer()).define(["d3","studentArray","homeworks"], _10);
  return main;
}
