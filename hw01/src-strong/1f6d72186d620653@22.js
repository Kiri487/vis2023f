...
function _8(d3,studentArray,homeworks)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["Plot","d3"], _7);
  main.variable(observer()).define(["d3","studentArray","homeworks"], _8);
  return main;
}
